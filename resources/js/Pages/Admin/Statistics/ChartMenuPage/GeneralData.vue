...
import TableGeneralData from '@/Components/custom/statistics/TableGeneralData.vue';
...
const deleteData = (): void => {
    ...
    router.delete(route("admin.chartGeneralDestroy", selectedId.value), {
        onFinish: () => {
