...
const { handleSubmit, setErrors } = useForm({
    ...
    initialValues: {
        ...
        label: undefined,
        jumlah: undefined,
        jenis_sapras: props.category
    }
});

const onSubmit = handleSubmit((values) => {
    router.post(route('admin.storeFacility', props.surveyID), values, {
...
<template>
    <Dialog>
        <DialogTrigger>
            <Button class="shadcn-btn edit-btn"><i class="fa-solid fa-plus"></i> Tambah Sarana Pra-sarana</Button>
        </DialogTrigger>
        <DialogContent class="flex flex-col">
            <DialogHeader>
                <DialogTitle>Tambah Sarana Pra-sarana: {{ category }}</DialogTitle>
                <DialogDescription>
